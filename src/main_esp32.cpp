...
//Green
const uint8_t farA   = 33;
const uint8_t closeA = 35;
const uint8_t midA   = 39;

//Red
const uint8_t farB   = 32;
const uint8_t closeB = 34;
const uint8_t midB   = 36;

// Mode + buzzer + buzzerVol
const uint8_t modePinBut = 27;
const uint8_t buzzerPin = 25;
const uint8_t buzzerVolBut = 26;
...
//maybe have WFL lockouts in the future???
...
// buzzer constants
//=================
const int buzzerVol[]  = {1,2,3,5,5};
const uint16_t buzzerTime[] = {1000, 3000, 5000}; // {foil, epee, sabre}
